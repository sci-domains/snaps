...
import { SCIContractProvider } from './providers/SCIContractProvider';
...
export const onTransaction: OnTransactionHandler = async ({
  ...
  const SCI = new SCIContractProvider({
    contractAddress: SCI_GOERLI_CONTRACT_ADDRESS,
  ...
  const isWhitelisted = await SCI.isVerifiedForDomain(
