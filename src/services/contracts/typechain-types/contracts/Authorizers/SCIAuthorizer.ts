...
export interface SCIAuthorizerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "IS_AUTHORIZED"
  ...
  encodeFunctionData(
    functionFragment: "IS_AUTHORIZED",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SCIAuthorizer extends BaseContract {
  connect(runner?: ContractRunner | null): SCIAuthorizer;
  waitForDeployment(): Promise<this>;

  interface: SCIAuthorizerInterface;
  ...
  IS_AUTHORIZED: TypedContractMethod<[], [string], "view">;
