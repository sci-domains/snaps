...
export interface RegistryV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADD_AUTHORIZER_ROLE"
      | "ADD_TRUSTED_VERIFIER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "ADD_TRUSTED_VERIFIER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface RegistryV1 extends BaseContract {
  connect(runner?: ContractRunner | null): RegistryV1;
  ...
  ADD_TRUSTED_VERIFIER_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "ADD_TRUSTED_VERIFIER_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
